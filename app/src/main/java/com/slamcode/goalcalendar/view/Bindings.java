...
public class Bindings {
    ...
    @BindingAdapter("categorySummarySource")
    public static void setCategorySummariesItemsSource(RecyclerView recyclerView, Collection<CategoryPlansViewModel> itemsSource)
    {
    ...
    @BindingAdapter("categoryNamesSource")
    public static void setCategoryNamesItemsSource(RecyclerView recyclerView, Collection<CategoryPlansViewModel> itemsSource)
    {
        if(recyclerView == null)
            return;
